...
export function deleteButton(user) { // Добавляет кнопку Edit и модальное окно, связь по id юзера
...
export function editButton(user) { // Добавляет кнопку Edit и модальное окно, связь по id юзера
